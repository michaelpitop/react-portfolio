    ...
    <section class="bg-white dark:bg-gray-900 rounded-lg">
      <div>
        <div class='flex text-[50px]  my-5 justify-center text-white'>
          <p><strong><em>Send me a message:</em></strong></p>
        </div>
        <div class='flex gap-9 flex-wrap	text-[40px] basis-10 justify-center	text-white'>
          ...
          {/* <a class="hover:text-sky-400" href="https://www.linkedin.com/in/michaelpitop/">LinkedIn</a> */}
      ...
      <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form ref={form} onSubmit={sendEmail} class="space-y-8">
              ...
              <button type="submit" class="border border-slate-300 hover:border-slate-400 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
              {successMessage && (
