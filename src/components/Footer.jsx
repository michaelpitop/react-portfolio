...
function Footer() {
  return (
    <footer class="flex relative bottom-0 left-0 right-0 gap-3 justify-center mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      {/* <p><a href="/" class="hover:underline">About</a></p>
      ...
      <a href="https://github.com/michaelpitop"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
